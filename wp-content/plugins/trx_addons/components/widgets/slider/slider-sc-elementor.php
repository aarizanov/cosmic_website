...
if (!function_exists('trx_addons_sc_slider_add_in_elementor')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_slider_add_in_elementor' );
...
if (!function_exists('trx_addons_sc_slider_controller_add_in_elementor')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_slider_controller_add_in_elementor' );
...
if (!function_exists('trx_addons_sc_slider_controls_add_in_elementor')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_slider_controls_add_in_elementor' );
