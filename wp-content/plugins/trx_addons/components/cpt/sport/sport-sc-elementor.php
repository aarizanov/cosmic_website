...
if (!function_exists('trx_addons_sc_matches_add_in_elementor')) {
	...
	// Register widgets
	add_action( 'elementor/widgets/register', 'trx_addons_sc_matches_add_in_elementor' );
...
if (!function_exists('trx_addons_sc_points_add_in_elementor')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_points_add_in_elementor' );
