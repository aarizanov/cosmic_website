...
if (!function_exists('trx_addons_sc_booked_add_in_elementor_ba')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_booked_add_in_elementor_ba' );
...
if (!function_exists('trx_addons_sc_booked_add_in_elementor_bp')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_booked_add_in_elementor_bp' );
...
if (!function_exists('trx_addons_sc_booked_add_in_elementor_bc')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_booked_add_in_elementor_bc' );
