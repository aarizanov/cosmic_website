...
if (!function_exists('trx_addons_sc_trx_donations_add_in_elementor_df')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_trx_donations_add_in_elementor_df' );
...
if (!function_exists('trx_addons_sc_trx_donations_add_in_elementor_dl')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_trx_donations_add_in_elementor_dl' );
...
if (!function_exists('trx_addons_sc_trx_donations_add_in_elementor_di')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_trx_donations_add_in_elementor_di' );
