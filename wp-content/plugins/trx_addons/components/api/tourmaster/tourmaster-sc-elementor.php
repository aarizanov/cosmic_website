...
if (!function_exists('trx_addons_sc_tourmaster_add_in_elementor_ttc')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_tourmaster_add_in_elementor_ttc' );
...
if (!function_exists('trx_addons_sc_tourmaster_add_in_elementor_tt')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_tourmaster_add_in_elementor_tt' );
...
if (!function_exists('trx_addons_sc_tourmaster_add_in_elementor_tts')) {
	add_action( 'elementor/widgets/register', 'trx_addons_sc_tourmaster_add_in_elementor_tts' );
