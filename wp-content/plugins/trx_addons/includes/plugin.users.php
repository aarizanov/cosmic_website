...
if ( !function_exists( 'trx_addons_users_localize_script' ) ) {
	...
	function trx_addons_users_localize_script($vars) {
		...
		$vars['msg_password_empty']			= addslashes(esc_html__("The password can't be empty and shorter than 4 characters", 'trx_addons'));
		$vars['msg_password_long']			= addslashes(esc_html__('The password is too long', 'trx_addons'));
		$vars['msg_login_success']			= addslashes(esc_html__('Login successful! The page should be reloaded in 3 sec.', 'trx_addons'));
