...
if ( ! function_exists( 'vixus_trx_addons_add_theme_vars' ) ) {
	add_filter( 'vixus_filter_add_theme_vars', 'vixus_trx_addons_add_theme_vars', 10, 2 );
	function vixus_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'vixus_trx_addons_get_css' ) ) {
	add_filter( 'vixus_filter_get_css', 'vixus_trx_addons_get_css', 10, 2 );
	function vixus_trx_addons_get_css( $css, $args ) {
...
ul.trx_addons_list_custom[class*="trx_addons_list"][class*="_circled"] > li:hover:before,
 ul.trx_addons_list_custom2[class*="trx_addons_list"][class*="_circled"] > li:hover:before {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
ul.trx_addons_list_custom[class*="trx_addons_list"][class*="_circled"]>li a:hover,
 ul.trx_addons_list_custom[class*="trx_addons_list"][class*="_circled"] > li:hover a,
  ul.trx_addons_list_custom2[class*="trx_addons_list"][class*="_circled"]>li a:hover,
 ul.trx_addons_list_custom2[class*="trx_addons_list"][class*="_circled"] > li:hover a {
    color: {$colors['text_hover']};
}
...
.trx_addons_hover_mask {
	background-color: {$colors['inverse_text_05']};
}
...
.sc_services_default .sc_button:hover {
    color: {$colors['text_link']};
}
...
.sc_services_light .sc_button:hover {
    color: {$colors['text_link']} !important;
}
