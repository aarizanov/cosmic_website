...
if ( !is_user_logged_in() ) {
	?><ul class="sc_layouts_login_menu sc_layouts_menu_nav sc_layouts_menu_no_collapse"><li class="menu-item"><a href="#trx_addons_login_popup" class="trx_addons_popup_link trx_addons_login_link sc_button color_style_dark sc_button_default sc_button_size_small sc_button_icon_left sc_button_hover_slide_top sc_button_hover_style_dark "><?php
		...
		<li class="menu-item<?php if (!empty($args['user_menu'])) { echo ' menu-item-has-children'; } ?>">
			<a href="<?php
				if (empty($args['user_menu']))
					...
					echo '#';
				?>" class="trx_addons_login_link sc_button color_style_dark sc_button_default sc_button_size_small sc_button_icon_left sc_button_hover_slide_top sc_button_hover_style_dark">
			...
			if (!empty($args['user_menu'])) {
				?><ul><?php
					...
					if (current_user_can('publish_posts')) {
						?><li class="menu-item trx_addons_icon-wpforms"><a href="<?php echo esc_url(trailingslashit(home_url('/'))); ?>wp-admin/post-new.php"><span><?php esc_html_e('New post', 'vixus'); ?></span></a></li><?php
						// Delimiter
						?><li class="menu-item menu-delimiter"></li><?php
					}
					do_action('trx_addons_action_login_menu_settings');
					// Settings
					?><li class="menu-item trx_addons_icon-cog"><a href="<?php echo esc_url(get_edit_user_link()); ?>"><span><?php esc_html_e('My profile', 'vixus'); ?></span></a></li><?php
					// Delimiter
					?><li class="menu-item menu-delimiter"></li><?php
					do_action('trx_addons_action_login_menu_logout');
					// Logout
					?><li class="menu-item trx_addons_icon-user-times"><a href="<?php echo esc_url(wp_logout_url(home_url('/'))); ?>"><span><?php esc_html_e('Logout', 'vixus'); ?></span></a></li><?php
