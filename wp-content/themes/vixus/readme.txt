...
WordPress version: required at least 4.5, tested up to 6.2.2
...
Please install and activate it before starting to use the theme Vixus.
...
Theme documentation is available on https://vixus.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Vixus is Fontello.
